    ...
    public static class SimpleStringRecyclerViewAdapter
        ...
        public static class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View view) {
                ...
                name = itemView.findViewById(R.id.lwi_name);
                price = itemView.findViewById(R.id.lwi_price);
            }
        }
        ...
        public void onBindViewHolder(final WishlistActivity.SimpleStringRecyclerViewAdapter.ViewHolder holder, final int position) {
            ...
            Product product = mWishlistImageUri.get(position);
            holder.name.setText(product.getmProductName());
            holder.price.setText(product.getmProductPrice());
            Picasso.with(mContext).load(mWishlistImageUri.get(position).getmImageUrl()).into(holder.mImageView);
